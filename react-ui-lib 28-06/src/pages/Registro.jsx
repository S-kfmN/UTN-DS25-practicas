  ...
  return (
    <Layout>
      <Box sx={{ maxWidth: 400, mx: 'auto' }}>
        ...
        <TextField fullWidth label="Apellido" name="apellido" margin="normal" required />
        <TextField fullWidth label="Fecha de Nacimiento" name="fecha_nac" type="date" margin="normal" InputLabelProps={{ shrink: true }} required />
        <TextField fullWidth label="Email" name="email" type="email" margin="normal" required />
        <TextField fullWidth label="Contraseña" name="clave" type="password" margin="normal" required />
        ...
        <FormControl fullWidth margin="normal">
          ...
          <Select labelId="tema-label" name="tema" defaultValue="" required>
